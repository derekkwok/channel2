...
class TagFormTest(test.TestCase):
    ...
    def test_clean_children(self):
        tag1 = tag_module.Tag.objects.create(name='tag 1')
        tag2 = tag_module.Tag.objects.create(name='tag 2')
        form = tag_form.TagForm()
    ...
    def test_clean_children_missing_tag(self):
        tag_module.Tag.objects.create(name='tag 1')
        form = tag_form.TagForm()
    ...
    def test_save_edit(self):
        child_tag1 = tag_module.Tag.objects.create(name='child tag 1')
        child_tag2 = tag_module.Tag.objects.create(name='child tag 2')
        parent_tag = tag_module.Tag.objects.create(name='parent tag')
        tag_module.TagChildren.objects.create(parent=parent_tag, child=child_tag1)
